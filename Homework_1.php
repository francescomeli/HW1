...
<html>
    <head>
        ...
        <script src="caricamento_api1.js" defer></script>
    </head>
            ...
            <nav>
                <?php
                    if(isset($_SESSION['username'])){
                        ...
                        echo "<a id='button' href='login.php'>Login</a>";
                        echo "<a id='button' href='iscrizione.php'>Iscriviti</a>";
                    }
                ?>
            </nav>
        ...
        <section>
            ...
            <div id="offerte">
                <div id="corso">
                    ...
                    <a class="descrizione" href="MHW4.php">I nostri corsi</a>
                    <p>
                ...
                <div id="piscine">
                    ...
                    <a class="descrizione" href="MHW2.php">Le nostre piscine</a>
                    <p>
                ...
                <div id="relax">
                    ...
                    <a class="descrizione" href="MHW3.php">Area relax</a>
                    <p>
